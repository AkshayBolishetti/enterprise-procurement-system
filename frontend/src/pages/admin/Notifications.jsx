...
export const Notifications = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-[var(--card)] p-6 rounded-3xl shadow-[0_2px_20px_rgba(0,0,0,0.02)] border border-[var(--input)]">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-[var(--foreground)]">Notifications</h1>
          <p className="text-sm text-[var(--secondary-foreground)] mt-1">Stay updated on procurement system events</p>
        </div>
      ...
      <div className="bg-[var(--card)] rounded-3xl shadow-[0_2px_20px_rgba(0,0,0,0.02)] border border-[var(--input)] divide-y divide-[var(--input)] overflow-hidden">
        {loading ? (
